...
public class Main {
    ...
    // local variable can be change and call only inside the class ( primitive data type)
    byte a = 10;
    short b = 20;
    int c = 30;
    long d = 40;
    ...
    public static void main(String[] args)    // main body of program
    {
        ...
        Main m = new Main();    // create an object by the name of  "Main"
        int sum = m.add(10,20);
        System.out.println(sum);

        Parrot parrot1 = new Parrot();   // object-1
